...
<style>
	...
	body {
				background-image: url(http://codegen.caihongy.cn/20210203/e223d37b69f44cb59e96fd07bb36fe98.jfif) !important;
	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="zhanghao" placeholder="账号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="nianling" placeholder="年龄" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">手机</label> 
							<input type="text" name="shouji" placeholder="手机" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">邮箱</label> 
							<input type="text" name="youxiang" placeholder="邮箱" class="form-control-i">
							</div>
																																			<div class="form-group">
							<label class="label">毕业学校</label> 
							<input type="text" name="biyexuexiao" placeholder="毕业学校" class="form-control-i">
							</div>
