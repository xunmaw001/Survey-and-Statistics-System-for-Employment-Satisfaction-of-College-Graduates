...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑用户</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>毕业学校</label>
										<input id="biyexuexiao" name="biyexuexiao" class="form-control" placeholder="毕业学校">
									</div>
									<div class="form-group col-md-6">
										<label>毕业年份</label>
										<div id="biyenianfenDate" class="input-append date form_datetime">
											<input id="biyenianfen-input" name="biyenianfen" size="15" type="text" readonly>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#biyenianfenDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#biyexuexiao").val(ruleForm.biyexuexiao);	
			$("#biyenianfen-input").val(ruleForm.biyenianfen);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.biyexuexiao != null && res.data.biyexuexiao != ''){

					$("#biyexuexiao").val(res.data.biyexuexiao);
					}
					if(res.data != null && res.data != '' && res.data.biyenianfen != null && res.data.biyenianfen != ''){

					$("#biyenianfen-input").val(res.data.biyenianfen);
					$('#biyenianfenFileName').val(res.data.biyenianfen)
					}
				}
			});  
            }
