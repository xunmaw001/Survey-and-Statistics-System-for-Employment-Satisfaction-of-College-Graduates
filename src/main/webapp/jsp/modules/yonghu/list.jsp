...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>用户列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="zhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('nianling')">年龄<i id="nianlingIcon" class="fa fa-sort"></i></th>
											...
											<th>照片</th>
											<th onclick="sort('biyexuexiao')">毕业学校<i id="biyexuexiaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('biyenianfen')">毕业年份<i id="biyenianfenIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#zhanghaoSearch').val() != null && $('#zhanghaoSearch').val() != ''){
				searchForm.zhanghao ="%" +  $('#zhanghaoSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var zhaopianCell  = document.createElement('td');

				                var zhaopianImg = document.createElement('img');
			zhaopianImg.setAttribute('src',item.zhaopian);
			zhaopianImg.setAttribute('height',100);
			zhaopianImg.setAttribute('width',100);
			zhaopianCell.appendChild(zhaopianImg);


			row.appendChild(zhaopianCell);
			var biyexuexiaoCell  = document.createElement('td');

						 biyexuexiaoCell.innerHTML = item.biyexuexiao;


			row.appendChild(biyexuexiaoCell);
			var biyenianfenCell  = document.createElement('td');

						  biyenianfenCell.innerHTML = item.biyenianfen;


			row.appendChild(biyenianfenCell);
