						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="biyexuexiao" name="biyexuexiao" class="form-control" v-model="ruleForm.biyexuexiao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>毕业年份</label>

									<input id="biyenianfen" name="biyenianfen" class="form-control" v-model="ruleForm.biyenianfen" readonly>
									</div>
