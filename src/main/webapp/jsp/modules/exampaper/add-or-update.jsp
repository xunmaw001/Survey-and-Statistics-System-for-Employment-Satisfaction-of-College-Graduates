					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑试卷表</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>试卷名称</label>
										<input id="name" name="name" class="form-control" placeholder="试卷名称">
									</div>
									<div class="form-group col-md-6">
										<label>考试时长(分钟)</label>
										<input id="time" name="time" class="form-control" placeholder="考试时长(分钟)">
									</div>
									<div class="form-group col-md-6">
										<label>试卷状态</label>
										<select id="statusSelect" name="status" class="form-control">
												<option value=""></option>
												<option class="statusOption" value="0">
													禁用 
												</option>
												<option class="statusOption" value="1">
													启用
												</option>
										</select>	
									</div>	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.time != null && res.data.time != ''){
