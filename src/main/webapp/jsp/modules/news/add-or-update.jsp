...
<body>
									...
									<div class="form-group col-md-6">
										...
										<input name="picture" id="picture-input" type="hidden"></div>
											...
											<div class="form-group  col-md-12">
												<label>内容</label>
												<div><div class="upload"><input id="contentupload" name="file" type="file">选择文件</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#introduction").val(ruleForm.introduction);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.introduction != null && res.data.introduction != ''){
