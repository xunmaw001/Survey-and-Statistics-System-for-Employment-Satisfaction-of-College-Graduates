      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="wenjuanmingcheng" name="wenjuanmingcheng" placeholder="请输入问卷名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="tongjirenshu" name="tongjirenshu" placeholder="请输入统计人数" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
