				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>问卷：</span>
							<span class="desc">
								<a download="wenjuan" :href="detail.wenjuan">点击下载</a>
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('wenjuan','查询人数')" @click="onAcrossTap('diaochatongjijieguo')" type="button" class="layui-btn">
								查询人数
							</button>
																					<button v-if="isAuth('wenjuan','提交')" @click="onAcrossTap('renwutijiao')" type="button" class="layui-btn">
								提交
							</button>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.wenjuanxiangqing"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`wenjuan`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.wenjuanmingcheng;
																				// 轮播图片
					vue.swiperList = vue.detail.wenjuanfengmian ? vue.detail.wenjuanfengmian.split(",") : [];
																																													var swiperItemHtml = '';
