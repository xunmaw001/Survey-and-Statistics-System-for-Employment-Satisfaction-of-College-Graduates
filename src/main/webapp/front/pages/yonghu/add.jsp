		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.biyexuexiao" type="text" name="biyexuexiao" id="biyexuexiao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">毕业年份：</label>
						<div class="layui-input-block">
							<input type="text" name="biyenianfen" id="biyenianfen" autocomplete="off" class="layui-input">
						</div>
					</div>
