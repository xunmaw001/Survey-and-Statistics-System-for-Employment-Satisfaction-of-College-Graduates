				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="biyexuexiao" id="biyexuexiao" placeholder="毕业学校" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">毕业年份</label>
							<div class="layui-input-block">
								<input type="text" name="biyenianfen" id="biyenianfen" placeholder="毕业年份" autocomplete="off" class="layui-input">
							</div>
						</div>
